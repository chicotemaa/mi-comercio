      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Iniciá sesión para administrar tu negocio y las reservas de la web.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" name="email" type="email" autoComplete="username" maxLength={254} placeholder="tu@email.com" required disabled={isLoading} />
              </div>
